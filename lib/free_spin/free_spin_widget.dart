...
import 'free_spin_model.dart';
export 'free_spin_model.dart';

class FreeSpinWidget extends StatefulWidget {
  const FreeSpinWidget({super.key});

  @override
  _FreeSpinWidgetState createState() => _FreeSpinWidgetState();
}

class _FreeSpinWidgetState extends State<FreeSpinWidget>
    with TickerProviderStateMixin {
  late FreeSpinModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FreeSpinModel());
  }
