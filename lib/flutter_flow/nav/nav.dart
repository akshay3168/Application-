      ...
      routes: [
        ...
        FFRoute(
          ...
          builder: (context, params) => RegisterWidget(
            aks: params.getParam('aks', ParamType.LatLng),
          ),
        ),
        FFRoute(
          name: 'FORGOTPASSWORD',
        ...
        FFRoute(
          name: 'OOTP',
          path: '/ootp',
          builder: (context, params) => const OotpWidget(),
        ),
        FFRoute(
          name: 'NEWPASSWORD',
          path: '/newpassword',
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'OFFERS')
              : const OffersWidget(),
        ),
        FFRoute(
          name: 'Checkout7',
        ...
        FFRoute(
          name: 'Registering_otp',
          path: '/registeringOtp',
          builder: (context, params) => const RegisteringOtpWidget(),
        ),
        FFRoute(
          name: 'home',
          path: '/home',
        ...
        FFRoute(
          name: 'Free_spin',
          path: '/freeSpin',
          builder: (context, params) => const FreeSpinWidget(),
        ),
        FFRoute(
          name: 'Pay_to_spin',
          path: '/payToSpin',
          builder: (context, params) => const PayToSpinWidget(),
        ),
        FFRoute(
          name: 'order_history',
          path: '/orderHistory',
        ...
        FFRoute(
          ...
          builder: (context, params) => const SmsConfirmationWidget(),
        ),
        FFRoute(
          name: 'editprofile',
          path: '/editprofile',
        ...
        FFRoute(
          ...
          path: '/deviceOrder',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'device_order')
              : const DeviceOrderWidget(),
        ),
        FFRoute(
          name: 'profile_pic_upload',
          path: '/profilePicUpload',
          builder: (context, params) => const ProfilePicUploadWidget(),
        )
